...
for(drug in drugnames){
	...
	saveRDS(datadf, paste0(outdir,"datadf_for_debugging.rds"))
	...
	p<-p+geom_line(data=sensdf, aes(x=x/1000, y=Min, color=conc), size=0.25, alpha=0.5)
	p<-p+geom_line(data=sensdf, aes(x=x/1000, y=Max, color=conc), size=0.25, alpha=0.5)
	p<-p+geom_line(data=sensdf, aes(x=x/1000, y=q02.5, color=conc), size=0.25, alpha=0.5)
	p<-p+geom_line(data=sensdf, aes(x=x/1000, y=q97.5, color=conc), size=0.25, alpha=0.5)
	p<-p+geom_line(data=sensdf, aes(x=x/1000, y=q50, color=conc), size=0.25, alpha=0.5)
